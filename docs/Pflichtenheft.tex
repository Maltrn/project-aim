...
Für den produktiven Einsatz der Software wird der Applicationserver Tomcat und eine Mongo Datenbank benötigt.
Die Anwendung selbst wird als .war Datei bereitgestellt und muss auf dem Tomcat Server deployed werden. Zusätzlich müssen alle verwendeteten Netzwerk-Ports freigeschaltet sein.
